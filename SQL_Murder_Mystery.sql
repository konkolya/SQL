...
WHERE date LIKE 20180115 AND city="SQL City";
...
SELECT * 
FROM person
WHERE name LIKE "%Annab%" AND address_street_name LIKE "%Franklin%"
...
SELECT * 
FROM get_fit_now_check_in WHERE membership_id in ("48Z7A", "48Z55")
...
SELECT p.*, d.gender, d.height, d.hair_color, d.car_make, d.car_model
